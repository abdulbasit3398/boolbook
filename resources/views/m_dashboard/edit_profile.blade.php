...
<!-- Modal Password -->
<div class="modal fade" id="modalPassword" tabindex="-1" role="dialog" aria-labelledby="firstnamelabel" aria-hidden="true">
	<div class="modal-dialog" role="document" style="margin: 200px auto;">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="vcenter">Wachtwoord veranderen</h4>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			</div>
			<div class="modal-body">
				<form method="post" class="col-md-12 form-material" action="{{route('update_profile')}}" style="margin: 0px 0px 25px 0px;">
					{{csrf_field()}}

					<div class="form-group">
						<input class="form-control" type="password" class="edit_field form-control" id="password" name="old_password" value="" placeholder="Typ je huidige wachtwoord" required>
					</div>
					<div class="form-group">
						<input class="form-control" type="password" class="edit_field form-control" id="password" name="password" value="" placeholder="Typ je nieuwe wachtwoord" required>
					</div>
					<div class="form-group">
						<input class="form-control" type="password" class="edit_field form-control" id="password" name="confirm_password" value="" placeholder="Bevestig je nieuwe wachtwoord" required>
						 
					</div>
					<div class="form-group">
						<input type="submit" name="submit" style="background: #7460ee;border: 1px solid #7460ee;float: right;" value="Nu veranderen" class="btn btn-primary">
					</div>
				</form>
			</div>
		</div>
	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<div class="row">
					<div class="col-md-5" style="display: grid;">
						<span class="form_total1" >Wachtwoord veranderen</span>
						<span class="regular_text">
							Wachtwoord veranderen
							<a data-toggle="modal" data-target="#modalPassword" href="#modalPassword" data-toggle="tooltip" data-original-title="Edit"> <i class="mdi mdi-pencil-circle text-inverse"></i> 
							</a>
						</span>
					</div>
					<div class="col-md-5" style="display: grid;">
						<span class="form_total1">Email</span>
						<span class="regular_text">
							{{$data->email}}
