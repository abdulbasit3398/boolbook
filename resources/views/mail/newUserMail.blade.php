    ...
    <div role="article" aria-label="Een email van Bolbooks" lang="nl" style="background-color: white; color: #2b2b2b; font-family: 'Poppins', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 720px; padding: 40px 20px 40px 20px;">
        ...
        <main>
            ...
            <p>
                ...
                We zijn blij dat je de keus hebt gemaakt om Bolbooks te gebruiken voor jouw boekhouding bij het verkopen op Bol.com. We verzekeren je dat je geen spijt van deze keuze zal krijgen.
                <br>
                <br>
                In de webapp heb je de uitlegvideo waarschijnlijk al gezien, maar als er nog onduidelijkheden zijn kun je een antwoord zoeken in onze kennisbank of contact opnemen met onze support!
