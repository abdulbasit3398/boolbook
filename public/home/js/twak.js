(function(global) {
    global.$_Tawk_AccountKey = '5dad88c7df22d91339a033b3';
    ...
    (function(global) {
        global.$_Tawk.widgetSettings = {
            ...
            "offlineForm": {
                ...
                "text": "Vul a.u.b. het onderstaande formulier in en wij zullen zo spoedig mogelijk contact met u opnemen.",
                "fields": [{
                    "label": "Naam",
                    "isRequired": true,
                    "type": "name"
            ...
            "prechatForm": null,
            "onlineGreeting": {
                "actionMessage": "Schrijf een antwoord..",
                "shortMessage": "Online",
                "longMessage": "Wij zijn live en klaar om nu met je te chatten. Zeg iets om een live chat te beginnen."
            },
            "awayGreeting": {
                "shortMessage": "Afwezig",
                "longMessage": ""
            },
            "cf": null,
            "emoji": true,
    ...
    (function(b) {
        ...
        a.chat.AGENT_JOIN_CONVERSATION = {
            message: "#n heeft zich aangesloten bij het gesprek",
            vars: ["n"]
        };
        a.chat.AGENT_LEFT_CONVERSATION = {
            message: "#n heeft het gesprek verlaten",
            vars: ["n"]
        };
        a.chat.Warning = {
        ...
        a.chat.dislike = {
            message: "Je vindt dit gesprek niet leuk"
        };
        a.chat.download = {
            message: "Download"
        };
        ...
        a.chat.like = {
            message: "Je vindt dit gesprek leuk"
        };
        a.chat.limit2 = {
        ...
        a.chat.messageQueuedTitile = {
            message: "bericht in de wachtrij"
        };
        ...
        a.form.MessageErrorMessage = {
            message: "Bericht is verplicht en mag niet langer zijn dan 500 karakters."
        };
        ...
        a.form.QuestionErrorMessage = {
            message: "Het veld 'Vraag' is verplicht en mag niet langer zijn dan 500 karakters."
        };
        ...
        a.transcript.CONVERSATION_STARTED_ON = {
            message: "Gesprek gestart om"
        };
        a.transcript.me = {
            message: "Ik"
        };
        a.transcript.transcriptStartedOn = {
            message: "#dateString, om #time",
            vars: ["dateString", "time"]
        };
        a.transcript.transcriptSubject = {
            message: "Chat e-mailafschrift op #host begonnen op #startedOn",
            vars: ["host", "startedOn"]
        };
        a.chat = a.chat || {};
        a.chat.hours = {
    ...
    (function(u) {
        ...
        try {
            ...
            B.prototype.getRotateStyling = function(a,
                c) {
            ...
            B.prototype.transformGreetings = function(a) {
                for (var c = /\[([^)]+)\]/, b = /\(([^)]+)\)/, k = /\[[^\]\(\)]+\]\((\bhttp:\/\/\b|\bhttps:\/\/\b|\bmailto:\b){1}[^\]\(\)]+\)/i,
                        s = "_blank", e = a, f, g; null !== (f = k.exec(e)) && (g = c.exec(f[0]), f = b.exec(f[0]), f[0].indexOf("(mailto:") || (s = "_top"), e = e.replace(g[0] + f[0], '<a target="' + s + '" href="' + f[1] + '" class="link">' + g[1] + "</a>"), e !== a););
                return e
            };
            B.prototype.checkWhiteLabelLink = function(a, c, d) {
                var k = 1E4 * Math.random(),
                    ...
                    f, g, h = null,
                    h = function() {
                        if (c.label !== a.innerHTML || c.url && c.url !== a.href || !c.url && a.href || c.id !== a.id || !e.getElementById(a.id) || c.cssText !== a.style.cssText) s.whiteLabelUnexpectedIssueLogged ||
                ...
                d ? this.messagePreviewCheckWhiteLabelRef = setTimeout(h, k) : this.checkWhiteLabelRef = setTimeout(h, k)
            };
            ...
            wa.prototype.log = function(a, b) {
                var d;
                b && a && (b.uiVersion = "v3", b.buildVersion = "679", b.buildCommit = "1c92a0ab1b2d24babba3377a900cd238b60e274c", d = {
                    type: a,
                    data: b
            ...
            X.prototype.extractRegisterData = function(a) {
                a.wdgt && (a.wdgt.lc !== u.widgetSettings.lc && (this.waitingForLanguage = !0, n.insertScript("https://static-v.tawk.to/679/languages/" + a.wdgt.lc + ".js")), m.processSettings(a.wdgt));
